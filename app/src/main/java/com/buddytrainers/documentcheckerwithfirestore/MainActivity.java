package com.buddytrainers.documentcheckerwithfirestore;
    ...
    public void addValuesToFirebaseFirestore(View view)
    {
        try
        {
            if(!documentIDET.getText().toString().isEmpty() && !studentNameET.getText().toString().isEmpty()
                ...
                objectMap.put("City", studentCityET.getText().toString());
            ...
            {
                Toast.makeText(this, "Please enter client city", Toast.LENGTH_SHORT).show();
            }
